...
public class A_BpreRequisite {
	
	// So far: .indexOf  & .contains() apply to strings and arrayLists (meaning of any type) where:
	 //[for strings:  .contains(String.valueOf('s')) // can the argument be 'si' ?    &  For arrayLists: .contains(variable: String or int or boolean or anything except a collection)  
